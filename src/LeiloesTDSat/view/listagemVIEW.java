...
public class listagemVIEW extends javax.swing.JFrame 
{
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        ProdutosDAO l = new ProdutosDAO();
        if (id.isEmpty()) 
        {
            JOptionPane.showMessageDialog(this, "Por favor, insira o ID do produto.", "ID do Produto Vazio", JOptionPane.WARNING_MESSAGE);
            return;
        }
        try 
        {
            int produtoId = Integer.parseInt(id);
            boolean vendaEfetuada = ProdutosDAO.venderProduto(produtoId);
            if (vendaEfetuada) 
            {
                JOptionPane.showMessageDialog(this, "Produto vendido com sucesso.", "Venda Efetuada", JOptionPane.INFORMATION_MESSAGE);
                l.listarProdutos();
                id_produto_venda.setText("");
            } 
            else 
            {
                JOptionPane.showMessageDialog(this, "Falha ao vender o produto.", "Erro na Venda", JOptionPane.ERROR_MESSAGE);
            }
        } 
        catch (SQLException e) 
        {
            JOptionPane.showMessageDialog(this, "Erro ao vender o produto: " + e.getMessage(), "Erro de Banco de Dados", JOptionPane.ERROR_MESSAGE);
        }  
   ...
   public void listarProdutos(List<ProdutosDTO> lista)
    {      
